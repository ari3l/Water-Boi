//
//  VCListingTableViewController.swift
//  TemplateApp
//
...
class VCListingTableViewController: UITableViewController {
    ...
    init() {
        ...
        self.title = "Debug View Controllers"
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let vcItem = self.vcs[indexPath.row]
        cell.textLabel?.text = vcItem.title
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let viewController = vcs[indexPath.row].vcClass.init()
